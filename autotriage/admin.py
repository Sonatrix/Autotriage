...
from autotriage.models import Queue, Ticket, FollowUp, PreSetReply, KBCategory
from autotriage.models import EscalationExclusion, EmailTemplate, KBItem
from autotriage.models import TicketChange, Attachment, IgnoreEmail
from autotriage.models import CustomField
...
#changed admin title and view site to custom 
admin.site.site_header = 'Trio support'
admin.site.site_url = '/autotriage'
