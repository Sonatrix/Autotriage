...
from autotriage.models import (Ticket, Queue, FollowUp, Attachment, IgnoreEmail, TicketCC,
...
class AbstractTicketForm(CustomFieldMixin, forms.Form):
    ...
    def _send_messages(ticket, queue, followup, files, user=None):
        ...
        if ticket.assigned_to and \
                ...
                ticket.assigned_to.usersettings_autotriage.settings.get('email_on_ticket_assign', False) and \
