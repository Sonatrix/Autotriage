...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(
                    upload_to=autotriage.models.attachment_path, verbose_name='File', max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(
                    verbose_name='Category', to='autotriage.KBCategory')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('queue', models.ForeignKey(
                    verbose_name='Queue', to='autotriage.Queue')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ticket', models.ForeignKey(
                    verbose_name='Ticket', to='autotriage.Ticket')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('followup', models.ForeignKey(
                    verbose_name='Follow-up', to='autotriage.FollowUp')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field', models.ForeignKey(
                    verbose_name='Field', to='autotriage.CustomField')),
                ('ticket', models.ForeignKey(
                    verbose_name='Ticket', to='autotriage.Ticket')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, verbose_name='ID', primary_key=True, serialize=False)),
                ('depends_on', models.ForeignKey(related_name='depends_on',
                                                 verbose_name='Depends On Ticket', to='autotriage.Ticket')),
                ('ticket', models.ForeignKey(related_name='ticketdependency',
                                             verbose_name='Ticket', to='autotriage.Ticket')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='queues',
            field=models.ManyToManyField(null=True, to='autotriage.Queue', blank=True,
