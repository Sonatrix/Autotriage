...
from autotriage import settings
from autotriage.lib import send_templated_mail, safe_template_context, process_attachments
from autotriage.models import Queue, Ticket, TicketCC, FollowUp, IgnoreEmail
...
def process_email(quiet=False):
    for q in Queue.objects.filter(
        ...
        logger = logging.getLogger('django.autotriage.queue.' + q.slug)
        ...
        logdir = q.logging_dir or '/var/log/autotriage/'
        ...
        if (q.email_box_last_check + queue_time_delta) < timezone.now():
            try:
                ...
                logger.error("Invalid credentials for this email id")
