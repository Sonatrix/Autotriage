...
from autotriage.views import feeds, staff, public, kb
...
urlpatterns += [
    url(r'^login/$',
        auth_views.login,
        {'template_name': 'autotriage/registration/login.html'},
        name='login'),

    url(r'^logout/$',
        auth_views.logout,
        {'template_name': 'autotriage/registration/login.html', 'next_page': '../'},
        name='logout'),
]
...
urlpatterns += [
    url(r'^help/context/$',
        TemplateView.as_view(template_name='autotriage/help_context.html'),
        name='help_context'),

    url(r'^system_settings/$',
        DirectTemplateView.as_view(
            template_name='autotriage/system_settings.html'),
